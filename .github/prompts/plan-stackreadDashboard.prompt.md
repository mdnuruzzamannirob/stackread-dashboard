...
- Permissions: members.*, staff.*, rbac.*
...
- Permissions: subscriptions.*, payments.*, promotions.*
...
- Permissions: reports.*, audit.*, settings.*
...
- Permissions: notifications.manage, reviews.*, reservations.*, borrows.*
